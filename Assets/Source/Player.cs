...
namespace LeanCloud.Play
{
    ...
    public class Player
    {
        ...
        public PlayerCharacter PlayerCharacter => MultiplayerMgr.Instance.PlayerCharacters.ContainsKey(this.ActorId)
            ? MultiplayerMgr.Instance.PlayerCharacters[this.ActorId]
            : null;
        ...
        public PlayObject CustomProperties { get; internal set; }
        ...
        public bool IsLocal
        {
            get { return ActorId != -1 && ActorId == Room.Player.ActorId; }
        }
        ...
        {
            get { return ActorId != -1 && ActorId == Room.MasterActorId; }
        }
